...
public class TmpHULiSensorCommand {
    ...
    {
        String result = GenericParser.Build(this, TmpHULiSensorCommand.class);
    ...
    public byte[] getBytesWithCRC()
    {
        return new byte[]{(byte)address,(byte)functionCode,(byte) (byte) ((startingRegAddr & 0x0000ff00) >>> 8),
                (byte) ((startingRegAddr & 0x000000ff)), (byte) ((dataLength & 0x0000ff00) >>> 8),
                (byte) ((dataLength & 0x000000ff)),(byte) ((crc & 0x0000ff00) >>> 8),
                (byte) ((crc & 0x000000ff))};
    }
...
// 2. Java object to JSON, and assign to a String
    ...
    public void calculateCRC()
    {
        ...
        crc = caculateCRC(cmdBytes);
    }

    public static short caculateCRC(byte[] data)
    {
        int crcInt = com.invertor.modbus.utils.CRC16.calc(data);
