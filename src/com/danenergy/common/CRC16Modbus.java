...
public class CRC16Modbus implements Checksum {
    ...
    public byte[] getCrcBytesReverse()
    {
        long crc = (int) this.getValue();
        byte[] byteStr = new byte[2];
    ...
    public static void main(String[] args) {
        ...
        //int[] data = new int[] {0x02,0x03,0x00,0x2A,0x00,0x01};
        //int[] data = new int[] {0x02,0x03,0x02,0x00,0x00};
        int[] data = new int[] {0x02,0x06,0x40,0x00,0x00};
        //int[] data = new int[] {0x03,0x06,0x20,0x00,0x00,0x03};
        for (int d : data) {
            crc.update(d);
        }
